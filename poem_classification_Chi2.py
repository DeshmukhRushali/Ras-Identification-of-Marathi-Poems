...
def trainkNeighbour(trainFeatures, trainLabels):
    print("k clss")
    clf = make_pipeline( KNeighborsClassifier(n_neighbors=12))
...
test = SelectKBest(score_func=chi2, k=1500)
...
trainFeatures, testFeatures, trainLabels, testLabels = train_test_split(features,labels, test_size=0.33, random_state=42)
